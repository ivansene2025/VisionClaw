...
#ifndef CAMERAACCESS_SWIFT_H
#define CAMERAACCESS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CameraAccess",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12CameraAccess19CustomVideoCapturer")
@interface CustomVideoCapturer : RTCVideoCapturer
...
SWIFT_CLASS("_TtC12CameraAccess19IPhoneCameraManager")
@interface IPhoneCameraManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVCaptureOutput;
@class AVCaptureConnection;
@interface IPhoneCameraManager (SWIFT_EXTENSION(CameraAccess)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

@class CLLocationManager;
@class CLLocation;
SWIFT_CLASS("_TtC12CameraAccess15LocationManager")
...
SWIFT_CLASS("_TtC12CameraAccess12WebRTCClient")
...
@interface WebRTCClient (SWIFT_EXTENSION(CameraAccess)) <RTCPeerConnectionDelegate>
